...
const DishList = [
    ...
    Kuba_selek, Kuskus, Mafrum, Makluba, MaroccanFish, Matbuha, MeoravYerushalmi, Memulaim, Mjadara, Musaka, 
    Olivier, Omelet, OzneyHaman, Pancake, PastaAlfredo, Pizza, Shakshuka, Schnitzel, StirFriedSalad, ThaiStirFried
];
...
const Artichoke         = new Dish("ארטישוק ממולא", ing_Artishok, ing_Silan, ing_garlic, ing_celery, ing_mince);
...
const Kneidlech         = new Dish("קניידלך", ing_KemahMaza, ing_eggs, ing_oil, ing_MarakOf, ing_dummy);
...
const Schnitzel         = new Dish("שניצל", ing_eggs, ing_breadcrumbs, ing_chickenbreast, ing_sesame, ing_HardalDizon);
...
const ing_humus         = myPath + "";  // גרגירי חומוס
const ing_jam           = myPath + "";  // ריבה
...
const ing_mince         = myPath + "";  // בשר טחון
