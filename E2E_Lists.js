...
const DateCookies       = new Dish("עוגיות תמרים", ing_datespread, ing_flour, ing_eggs, ing_mahmha, ing_bakingpowder);
...
const ing_bakingpowder  = myPath + "";  // אבקת עפיה
...
const ing_matzaflour    = myPath + "";  // קמח מצה
...
const ing_vanillapudding = myPath + ""; // פוגינג וניל 
